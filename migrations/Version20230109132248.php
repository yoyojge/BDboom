...
final class Version20230109132248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE album_collection (id INT AUTO_INCREMENT NOT NULL, album_id INT NOT NULL, collection_id INT NOT NULL, INDEX IDX_F44D76171137ABCF (album_id), INDEX IDX_F44D7617514956FD (collection_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE album_collection ADD CONSTRAINT FK_F44D76171137ABCF FOREIGN KEY (album_id) REFERENCES album (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album_collection DROP FOREIGN KEY FK_F44D76171137ABCF');
